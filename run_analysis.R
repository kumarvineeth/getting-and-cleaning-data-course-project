# for wearables project - Getting and Cleaning Data course, Assignment - 02-Aug-2017

#script is to be run from Programming folder
#get data from UCI site and unzip to my Programming/Data folder..
...
# Assign appropriate names to each col..
